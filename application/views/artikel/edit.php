...
<div class="container">
	...
	<div class="row">
		<?php echo form_open('artikel/edit/'.$artikel_item['id'] ); ?>
			<div class="row">
			<div class="input-field col s12">
	          <input  id="first_name" type="text" name="judul" class="validate" value="<?=$artikel_item['judul'] ?>">
	          <label for="first_name">Judul</label>
	          <?php echo form_error('judul') ?>
	        </div>
	        <div class="input-field col s12">
	          <textarea id="textarea1" name="konten" class="materialize-textarea"><?=$artikel_item['isi'] ?></textarea>
